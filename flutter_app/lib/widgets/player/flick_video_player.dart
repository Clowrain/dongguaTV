...
class _FlickVideoPlayerState extends State<FlickVideoPlayer>
  ...
  Widget build(BuildContext context) {
    final bool showTopBar = widget.onBack != null || widget.topBarRightWidget != null;
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          // 顶部栏 - 使用 FlickAutoHideChild 控制显示
          if (showTopBar)
            Positioned(
              top: 0,
              left: 0,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        // 右侧自定义组件
                        if (widget.topBarRightWidget != null)
                          widget.topBarRightWidget!,
                      ],
                    ),
                  ),
                ),
